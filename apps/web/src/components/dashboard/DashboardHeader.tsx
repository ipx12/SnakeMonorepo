export function DashboardHeader() {
  return (
    <div className="text-center relative">
      ...
      <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-linear-to-r from-emerald-400 via-teal-300 to-indigo-400 bg-clip-text text-transparent">
